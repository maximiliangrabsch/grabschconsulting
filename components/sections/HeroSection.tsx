  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 mx-auto max-w-5xl px-6 py-40 text-center md:py-56">
        <motion.div initial="hidden" animate="visible" variants={staggerFast} className="flex flex-col items-center gap-7">
          ...
          >
            {t.hero.headline1}{" "}
            <span className="text-primary-400">{t.hero.headline2}</span>
          </motion.h1>
