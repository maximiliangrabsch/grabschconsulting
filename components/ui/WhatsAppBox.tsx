  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="font-semibold text-white">{w.boxHeadline}</h3>
          <p className="text-sm text-neutral-400">{w.boxSub}</p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex w-full items-center justify-center gap-2 rounded-xl border border-[#25D366]/60 px-4 py-2.5 text-sm font-semibold text-[#25D366] transition hover:border-[#25D366] hover:bg-[#25D366]/10"
        >
          <WhatsAppIcon className="h-4 w-4" />
          {w.developer}
        </a>
      ...
      {/* Hours note */}
      <p className="text-xs text-neutral-600">{w.hours}</p>
    </div>
  );
}
